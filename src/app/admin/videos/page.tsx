      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        {videos.length === 0 ? (
          <div className="text-center py-12">
            <div className="text-gray-500">등록된 영상이 없습니다.</div>
            <Link
              href="/admin/videos/new"
              ...
              <div key={video.videoId} className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  {video.analysis?.summary && (
                    <div className="mb-3">
                      <div className="text-xs font-medium text-gray-700 mb-1">요약</div>
                  ...
                  {/* Keywords */}
                  {video.analysis?.keywords && video.analysis.keywords.length > 0 && (
                    <div className="mb-3">
                      <div className="text-xs font-medium text-gray-700 mb-1">키워드</div>
                      <div className="flex flex-wrap gap-1">
                        {video.analysis.keywords.slice(0, 3).map((keyword, index) => (
                          <span
                            key={index}
                        ...
                        {video.analysis.keywords.length > 3 && (
                          <span className="text-xs text-gray-500">
                            +{video.analysis.keywords.length - 3} more
                          </span>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="pt-3 border-t border-gray-200">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      >
                        ...
                        {deleting === video.videoId ? '삭제 중...' : '삭제'}
                      </button>
                    </div>
                  </div>
                </div>
