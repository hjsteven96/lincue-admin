...
export async function GET() {
  try {
    ...
    const videosSnapshot = await adminDb.collection('videoAnalyses').orderBy('timestamp', 'desc').get();
...
export async function PUT(request: Request) {
  try {
    ...
    await adminDb.collection('videoAnalyses').doc(videoId).update(updateData);
